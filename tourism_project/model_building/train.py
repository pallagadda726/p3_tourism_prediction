...
mlflow.set_experiment("tourism_MLOps_experiment")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    ...
    'xgbclassifier__reg_lambda': [1, 1.5, 2],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
...
with mlflow.start_run():
    ...
    model_path = "/content/drive/MyDrive/ColabNotebooks/P3_TourismPrediction/tourism_project/deployment/best_model.joblib"  
