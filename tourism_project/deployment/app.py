...
model_path = os.path.join(os.path.dirname(__file__), "/content/drive/MyDrive/ColabNotebooks/P3_TourismPrediction/tourism_project/deployment/best_model.joblib")
